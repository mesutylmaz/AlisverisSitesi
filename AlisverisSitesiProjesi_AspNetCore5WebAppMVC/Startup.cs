...
namespace AlisverisSitesiProjesi_AspNetCore5WebAppMVC
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllersWithViews().AddRazorRuntimeCompilation();     //Frontendde yapýlan deðiþikliklerin anlýk olarak yansýmasýný görmemizi saðlar.
            ...
            {
                options.IdleTimeout = TimeSpan.FromMinutes(30);     //Oturum yarým saat sonra kapanacak
